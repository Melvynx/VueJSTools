...
methods: {
  ...
  toursTimer() {
    ...
    newTours = new toursTimer(this.minutes, this.secondes, this.ms, this.tours);
    this.tours.push(newTours);
    lastTour = findTheBiggestID(this.tours) - 2;
    console.log(this.tours);
    console.log(lastTour)
    console.log(this.tours[lastTour])
    this.minutesLastTour = this.minutes - Number(this.tours[lastTour].minutes);
    this.secondesLastTour = this.secondes - Number(this.tours[lastTour].secondes);
